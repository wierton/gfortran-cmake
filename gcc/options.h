...
enum opt_code
{
  ...
  OPT_list = 1770,                           /* -list */
  OPT_m128bit_long_double = 1771,            /* -m128bit-long-double */
  OPT_m16 = 1772,                            /* -m16 */
  OPT_m32 = 1773,                            /* -m32 */
  OPT_m3dnow = 1774,                         /* -m3dnow */
  OPT_m3dnowa = 1775,                        /* -m3dnowa */
  OPT_m64 = 1776,                            /* -m64 */
  OPT_m80387 = 1777,                         /* -m80387 */
  OPT_m8bit_idiv = 1778,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1779,             /* -m96bit-long-double */
  OPT_mabi_ = 1780,                          /* -mabi= */
  OPT_mabm = 1781,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1782,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1783,                 /* -maddress-mode= */
  OPT_madx = 1784,                           /* -madx */
  OPT_maes = 1785,                           /* -maes */
  OPT_malign_data_ = 1786,                   /* -malign-data= */
  OPT_malign_double = 1787,                  /* -malign-double */
  OPT_malign_functions_ = 1788,              /* -malign-functions= */
  OPT_malign_jumps_ = 1789,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1790,                  /* -malign-loops= */
  OPT_malign_stringops = 1791,               /* -malign-stringops */
  OPT_mamx_bf16 = 1792,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1793,                      /* -mamx-int8 */
  OPT_mamx_tile = 1794,                      /* -mamx-tile */
  OPT_mandroid = 1795,                       /* -mandroid */
  OPT_march_ = 1796,                         /* -march= */
  OPT_masm_ = 1797,                          /* -masm= */
  OPT_mavx = 1798,                           /* -mavx */
  OPT_mavx2 = 1799,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1800,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1801,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1802,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1803,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1804,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1805,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1806,                      /* -mavx512bw */
  OPT_mavx512cd = 1807,                      /* -mavx512cd */
  OPT_mavx512dq = 1808,                      /* -mavx512dq */
  OPT_mavx512er = 1809,                      /* -mavx512er */
  OPT_mavx512f = 1810,                       /* -mavx512f */
  OPT_mavx512fp16 = 1811,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1812,                    /* -mavx512ifma */
  OPT_mavx512pf = 1813,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1814,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1815,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1816,                      /* -mavx512vl */
  OPT_mavx512vnni = 1817,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1818,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1819,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1820,                       /* -mavxvnni */
  OPT_mbionic = 1821,                        /* -mbionic */
  OPT_mbmi = 1822,                           /* -mbmi */
  OPT_mbmi2 = 1823,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1824,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1825,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1826,                    /* -mcet-switch */
  OPT_mcld = 1827,                           /* -mcld */
  OPT_mcldemote = 1828,                      /* -mcldemote */
  OPT_mclflushopt = 1829,                    /* -mclflushopt */
  OPT_mclwb = 1830,                          /* -mclwb */
  OPT_mclzero = 1831,                        /* -mclzero */
  OPT_mcmodel_ = 1832,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1833, */                    /* -mcpu= */
  OPT_mcrc32 = 1834,                         /* -mcrc32 */
  OPT_mcx16 = 1835,                          /* -mcx16 */
  OPT_mdirect_extern_access = 1836,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1837,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1838,            /* -mdump-tune-features */
  OPT_menqcmd = 1839,                        /* -menqcmd */
  OPT_mf16c = 1840,                          /* -mf16c */
  OPT_mfancy_math_387 = 1841,                /* -mfancy-math-387 */
  OPT_mfentry = 1842,                        /* -mfentry */
  OPT_mfentry_name_ = 1843,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1844,               /* -mfentry-section= */
  OPT_mfma = 1845,                           /* -mfma */
  OPT_mfma4 = 1846,                          /* -mfma4 */
  OPT_mforce_drap = 1847,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1848,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1849,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1850,                       /* -mfpmath= */
  OPT_mfsgsbase = 1851,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1852,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1853, */              /* -mfused-madd */
  OPT_mfxsr = 1854,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1855,             /* -mgeneral-regs-only */
  OPT_mgfni = 1856,                          /* -mgfni */
  OPT_mglibc = 1857,                         /* -mglibc */
  OPT_mhard_float = 1858,                    /* -mhard-float */
  OPT_mharden_sls_ = 1859,                   /* -mharden-sls= */
  OPT_mhle = 1860,                           /* -mhle */
  OPT_mhreset = 1861,                        /* -mhreset */
  OPT_miamcu = 1862,                         /* -miamcu */
  OPT_mieee_fp = 1863,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1864,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1865,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1866,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1867,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1868,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1869,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1870,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1871, */            /* -mintel-syntax */
  OPT_mkl = 1872,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1873,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1874,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1875,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1876,                /* -mlong-double-80 */
  OPT_mlwp = 1877,                           /* -mlwp */
  OPT_mlzcnt = 1878,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1879,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1880,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1881,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1882,                  /* -mmitigate-rop */
  OPT_mmmx = 1883,                           /* -mmmx */
  OPT_mmovbe = 1884,                         /* -mmovbe */
  OPT_mmovdir64b = 1885,                     /* -mmovdir64b */
  OPT_mmovdiri = 1886,                       /* -mmovdiri */
  OPT_mmove_max_ = 1887,                     /* -mmove-max= */
  OPT_mmpx = 1888,                           /* -mmpx */
  OPT_mms_bitfields = 1889,                  /* -mms-bitfields */
  OPT_mmusl = 1890,                          /* -mmusl */
  ...
  OPT_mx32 = 1972,                           /* -mx32 */
  OPT_mxop = 1973,                           /* -mxop */
  OPT_mxsave = 1974,                         /* -mxsave */
  OPT_mxsavec = 1975,                        /* -mxsavec */
  OPT_mxsaveopt = 1976,                      /* -mxsaveopt */
  OPT_mxsaves = 1977,                        /* -mxsaves */
  OPT_n = 1978,                              /* -n */
  ...
  OPT_profile = 2013,                        /* -profile */
  OPT_pthread = 2014,                        /* -pthread */
  OPT_quiet = 2015,                          /* -quiet */
  OPT_r = 2016,                              /* -r */
  OPT_rdynamic = 2017,                       /* -rdynamic */
  ...
  OPT_time = 2103,                           /* -time */
  OPT_time_ = 2104,                          /* -time= */
  OPT_tno_android_cc = 2105,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2106,                 /* -tno-android-ld */
